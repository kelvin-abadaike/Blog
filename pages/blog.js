...
const blog = () => {
  return (
    <div>
      ...
      <div className="grid grid-col-1 md:grid-col-3 lg:grid-cols-4 gap-5">
        <div className="col-span-3 grid grid-col-1 md:grid-cols-2">
          {[0, 1, 2, 3, 4, 5, 6, 7].map((e, idx) => (
            <Card5 key={idx} />
          ))}
        </div>
        <div className="col-span-3 lg:col-span-1 px-5">
          <div className="px-5 py-36 bg-gray-500 text-center text-white mb-3 ">
            Place Your Ads
          </div>
          <div>
            <Section3 />
