...
const Card5 = () => {
  return (
    <div>
      <div className="shadow-sm bg-white flex-wrap relative">
        <div className="p-6">
        ...
        <div className="h-10 w-20 flex justify-center items-center bg-gray-200 text-purple-500 rounded-2xl absolute top-10 left-10">
          EVENTS
        </div>
        <div className=" pl-6">
